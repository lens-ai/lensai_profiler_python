...
class TestSketches(unittest.TestCase):
    ...
    def test_update_kll_sketch_tensorflow(self):
        ...
        self.assertGreater(len(self.sketches.sketch_registry['brightness'].items), 0)
    ...
    def test_update_sketches_tensorflow(self):
        ...
        self.assertGreater(len(self.sketches.sketch_registry['brightness'].items), 0)
        self.assertGreater(len(self.sketches.sketch_registry['sharpness'].items), 0)
        self.assertGreater(len(self.sketches.sketch_registry['snr'].items), 0)
        self.assertGreater(len(self.sketches.sketch_registry['channel_mean'][0].items), 0)
        self.assertGreater(len(self.sketches.sketch_registry['channel_pixels'][0].items), 0)
    ...
    def test_save_and_load_sketches(self):
        ...
        self.assertEqual(len(new_sketches.sketch_registry['brightness'].items), len(self.sketches.sketch_registry['brightness'].items))
    ...
    def test_custom_metric_logging(self):
        ...
        self.assertGreater(len(self.sketches.sketch_registry['embeddings'].items), 0)
